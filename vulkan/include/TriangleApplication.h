...
namespace engine
{
    ...
    private:
        ...
        void vk_create_image(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory) const;

        void vk_create_texture_image( );
        void vk_create_texture_image_view();
        void vk_create_texture_sampler();
        void vk_transition_image_layout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout) const;
        void vk_copy_buffer_to_image(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) const;
        [[nodiscard]] VkImageView vk_create_image_view(VkImage image, VkFormat format) const;
