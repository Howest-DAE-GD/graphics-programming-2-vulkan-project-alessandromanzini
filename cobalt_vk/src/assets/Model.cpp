...
namespace cobalt_vk
{
    void Model::create_vertex_buffer( const VkDevice device, const VkPhysicalDevice physicalDevice,
                                      const VkCommandPool commandPool, const VkQueue graphicsQueue )
    {
        ...
        Buffer::vk_create_buffer( device, physicalDevice, bufferSize,
    ...
    void Model::release( VulkanInstance& instance )
    {
